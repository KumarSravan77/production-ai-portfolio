const projects = [
  ...
  { n: "10", title: "Production AI Guardrails", proof: "Policy enforcement at every untrusted boundary", text: "Versioned input/output policy, prompt-injection and harm detection, Canadian PII and secret redaction, tool authorization, SSRF defense, privacy-safe audits, and adversarial release gates.", tags: ["AI Security", "Policy engine", "ASGI"], repo: "security-guardrail-middleware" },
