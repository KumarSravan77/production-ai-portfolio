const projects = [
  ...
  { n: "06", title: "Streaming Copilot UI", proof: "A responsive experience that degrades safely", text: "Real-time streaming, optimistic state, accessible controls, and complete-response fallback.", tags: ["React", "Streaming", "UX"], repo: "streaming-copilot-ui", live: "https://vector-copilot-live.sra1kmr.chatgpt.site" },
